...
type odmapElement[K comparable, V any] struct {
	// Next and previous pointers in the doubly-linked list of elements.
	// To simplify the implementation, internally a list l is implemented
	// as a ring, such that &l.root is both the next element of the last
	// list element (l.Back()) and the previous element of the first list
	// element (l.Front()).
	next, prev *odmapElement[K, V]
...
func (e *odmapElement[K, V]) Next() *odmapElement[K, V] {
	return e.next
}

// Prev returns the previous list element or nil.
func (e *odmapElement[K, V]) Prev() *odmapElement[K, V] {
	return e.prev
}
...
type list[K comparable, V any] struct {
	root odmapElement[K, V] // list head and tail
}
...
func (l *list[K, V]) Front() *odmapElement[K, V] {
	return l.root.next
}

// Back returns the last element of list l or nil if the list is empty.
func (l *list[K, V]) Back() *odmapElement[K, V] {
	return l.root.prev
}

// Remove removes e from its list
func (l *list[K, V]) Remove(e *odmapElement[K, V]) {
	if e.prev == nil {
		l.root.next = e.next
	} else {
		e.prev.next = e.next
...
func (l *list[K, V]) PushFront(key K, value V) *odmapElement[K, V] {
	e := &odmapElement[K, V]{Key: key, Value: value}
	if l.root.next == nil {
...
func (l *list[K, V]) PushBack(key K, value V) *odmapElement[K, V] {
	e := &odmapElement[K, V]{Key: key, Value: value}
	if l.root.prev == nil {
		// It's the first element
		l.root.next = e
